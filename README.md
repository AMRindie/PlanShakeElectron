...
<p align="center">
  <strong>A beautiful, offline-first project management application</strong>
</p>
...
### Desktop App 
Download the latest release from the [Releases Page](https://github.com/AMRindie/PlanShakeElectron/releases) and run the installer for your platform.

or you can use [AMRApps](https://amrapps.netlify.app/app.html?id=planshake) website to download it

## Tech Stack

- **Electron** — Cross-platform desktop framework
- **HTML/CSS/JavaScript** — Pure web technologies, no heavy frameworks
- **LocalStorage/IndexedDB** — Persistent local data storage
